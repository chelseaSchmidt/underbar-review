(function() {
  ...
  _.last = function(array, n) {
    ...
    //if n is undefined,
    if (n === undefined || n === 1) {
      //find last element and return it
    ...
    //return slice of array based on n
  ...
  _.every = function(collection, iterator) {
    ...
    //reduce each elem in collection to a boolean value
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      if (inputs in storedResults) {
        return storedResults[inputs];
      } else {
        let newOutput = func.apply(this, arguments);
        storedResults[inputs] = newOutput;
        return newOutput;
      }
    };
  ...
  _.delay = function(func, wait) {
    //use setTimeout on function call with func inside and wait
